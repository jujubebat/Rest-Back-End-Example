...
public class QProduct extends EntityPathBase<Product> {
    ...
    private static final long serialVersionUID = -1626961161L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QProduct product = new QProduct("product");

    public final NumberPath<Long> appraisedPrice = createNumber("appraisedPrice", Long.class);

    public final NumberPath<Long> bidBeginDateTime = createNumber("bidBeginDateTime", Long.class);

    public final NumberPath<Long> bidCloseDateTime = createNumber("bidCloseDateTime", Long.class);
